...
namespace QuanLyNhaThuocTay
{
    public partial class frmDMChatLieu : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'quanLyNhaThuocTayDataSet4.tblChatLieu' table. You can move, or remove it, as needed.
            this.tblChatLieuTableAdapter.Fill(this.quanLyNhaThuocTayDataSet4.tblChatLieu);
        ...
        private void LoadDataGridView()
        {
            ...
            tblCL = Functions.GetDataToDataTable(sql);
        ...
        private void frmDMChatLieu_Click(object sender, EventArgs e)
        {
